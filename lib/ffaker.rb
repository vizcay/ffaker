module Faker
  ...
  autoload :AddressAR,     'ffaker/address_ar'
  ...
  autoload :CompanyAR,     'ffaker/company_ar'
  ...
  autoload :InternetAR,    'ffaker/internet_ar'
  ...
  autoload :PhoneNumberAR, 'ffaker/phone_number_ar'
  ...
  autoload :ProductAR,     'ffaker/product_ar'
